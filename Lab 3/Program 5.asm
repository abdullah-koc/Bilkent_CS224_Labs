#copying linkedlist by recursion
	.text
...
# 
	...
	move $s6, $v0	#Copied linked list is pointed by $v0
	move $t0, $a0
	...
	move 	$a0, $t0
	jal printLinkedList	#print original list again in order to show that list is still available
...
copyOthersRecursively:
	...
	jal copyOthersRecursively	#recursive call
...
Finish:
	move $a0, $s6	#keep current list's head
	move $v0, $s2	#return
	jr $ra
	.data
line:	
...
copySuccess: 
	.asciiz "\nThe linkedlist is successsfully copied. New linkedlist:\n "
